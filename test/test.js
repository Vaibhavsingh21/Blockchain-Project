...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    return auctionInstance.bid(itemId=0, count=6, {from: accounts[1]})/*<CODE HERE>*/
    .then(function (result) {
      /*
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
        return auctionInstance.winners(itemId=0, {from: accounts[0]})/*<CODE HERE>*/
    }).then(function(result) {
      /**********
      ...
      ***********/
      assert.notEqual(result, 0x0000000000000000000000000000000000000000, 'bidders address not set')/*<CODE HERE>*/
      /**********
      TASK 16: call winners function from accounts[0] to get the winner of item id 1
      ***********/
      return auctionInstance.winners(itemId=1, {from: accounts[0]})/*<CODE HERE>*/
    }).then(function(result) {
      /**********
      ...
      ***********/
      return auctionInstance.winners(itemId=2, {from: accounts[0]})/*<CODE HERE>*/
    }).then(function(result) {
      /**********
